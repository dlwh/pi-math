...
export const Text = z.string().trim().min(1).max(60_000);
...
export interface Bundle<T> {
  id: string; value: T; objections: Objection[];
  reviews: { id: string; review: Review }[]; parents: string[];
}
...
export const ConfigSchema = z.object({
  ...
  maxCalls: z.number().int().min(1).max(10_000).default(160),
  maxOutputTokens: z.number().int().min(128).max(32_768).default(4096),
  maxReservedOutputTokens: z.number().int().min(128).max(100_000_000).default(655_360),
  maxInputChars: z.number().int().min(1000).max(2_000_000).default(240_000),
  timeoutMs: z.number().int().min(10).max(900_000).default(120_000),
